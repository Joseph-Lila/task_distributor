...
requirements = python3,sdl2_ttf,aiosqlite,asynckivy,Kivy==2.1.0,kivymd==1.1.1,loguru,pillow==9.2.0,certifi,jnius,charset_normalizer,idna,requests,python_dateutil,asyncgui,jnius,android.permissions
